    ...
    themeConfig: {
        locales: {
            '/': {
                ...
                label: '简体中文',
                nav: [
                    { text: '服规', link: 'https://hello.mckfs.com/ServerRules.html' },{ text: ' 游戏实时状态', link: 'https://hello.mckfs.com/Status.html' },{ text: ' 加入我们', link: 'https://jq.qq.com/?_wv=1027&k=mS9tw9Gi' },
                ],
                sidebar: [
                    ['/', '前言'],
                    ['/ServerHistory', '服务器历史'],
