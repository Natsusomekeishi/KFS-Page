...
如果你的朋友想加入本服务器，请让他加入 **交流审核群：314707427**，按正常规定审核。
...
## 服务器对外交流群条例
::: tip 提示
服务器 **允许** 并提倡玩家在群外进行任何形式的 **积极宣传** ，如视频宣传、图文帖子宣传等，务必注明对外交流群群号（314707427）。
...
3. 在加入群聊的玩家未过审前，允许已入服玩家积极宣传自己所在服务器的内容（柚服或雪国），让玩家在审核结束后选择加入自己所在的服务器，注意宣传内容需要积极正向、合理规范，不要坑蒙拐骗玩家（如入服送现金、入服有女朋友等）以达成目的，可通过服务器建筑实景、玩家成就、对新人物资补助等方式宣传。
...
以“地狱大厅”为例，地狱大厅按大小属于中型建筑，在其之下均为小型建筑，在其之上均为大型建筑（特大型建筑另议）。按建造难度来说，属于该大小建筑中较难的一种，建造于危险的地狱、需要清理基岩层，耗时较长，所以参与建造的成员可以获得+1~2分，设计者可以获得+2分（原创建筑+中型建筑）。

以“工具人协会”为例，工具人协会按大小属于小型偏中型建筑，但并非原创，所以没有设计者加分，且于主世界平原上建造，没有大量清理地形，难度较低，参与建造的成员可以获得+1分，但如果参与人较少，则有可能获得+2分。

以“树厂”为例，仅处理橡木桦木的树厂较为简单，且并非原创，没有设计加分，所需材料也较少，不能评为加分项目，但考虑到实用性，建造者可以通过证明其产出大量原木，来证明对玩家的实用性，获得+1分的小贡献。

2. 雪国例子：

以“幽都部落”为例，幽都部落建筑（指中式围墙内）由于风格一致，所以可以归为一个独立建筑，按大小属于中型建筑，在其之下均为小型建筑，在其之上均为大型建筑（特大型建筑另议）。按建造难度来说，因为建造在主世界平原，属于该大小建筑中适中难度的一种，所以参与建造的成员可以获得+1分，但如果参与人较少，则有可能获得+2分，设计者可以获得+2分（原创建筑+中型建筑）。

以“梁龙山”为例，梁龙山部落建筑（城墙内）由于风格不同，且非原创项目过多，理应不能加设计分，但是由于其和谐统一的部落性质，在整体美观性上为主要建造者+1分，参与建造人较多且都为小型建筑，所以没有加分。
...
1. 参与补考，需达到85分以上才能过审，可按情况加奖惩值（一般情况下1~2分）。
2. 需注意的是，返回服务器需提交200字书面检讨。
3. 补考特殊加分每人只限一次，且必须因上述情况下才可以申请。
